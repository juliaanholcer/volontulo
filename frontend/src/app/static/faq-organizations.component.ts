...
zawierania porozumień z wolontariuszami, zwanych w ustawie korzystającymi. Są nimi: 
    ...
    },
    {
      ...
      answer: `Podmioty, na rzecz których wolontariusz może wykonywać świadczenia zostały określone powyżej. Ponadto, ze względu na cel i 
      charakter świadczeń wolontariuszy nie jest dopuszczalne, aby wykonywali oni świadczenia na rzecz przedsiębiorców i innych 
